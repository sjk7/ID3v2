...
constexpr const char* const genres[] = {"Blues", "Classic Rock", "Country",
    ...
    "Avant-garde", "Gothic Rock", "Progressive Rock", "Psychedelic Rock",
    ...
    "Hardcore Techno", "Terror", "Indie", "Britpop", "Worldbeat", "Polsk Punk",
...
constexpr inline auto GENRE_SIZE = sizeof(genres) / sizeof(genres[0]);
} // namespace ID3v1
